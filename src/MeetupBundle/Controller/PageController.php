...
class PageController extends Controller
{
    public function showAction()
    {
        ...
        array(
            ...
            'datedExtract' => $datedExtract,

            'datedFormat' => $datedFormat
        )
    );

    }
    public function showParisAction()
    {
        ...
        return $this->render('MeetupBundle:Default:accueil-paris.html.twig',
        array(
            'membresParis'            =>$membresParis,
    ...
    public function showRetroAction($retroDeb, $retroFin)
    {
        ...
        $repository = $this
            ...
            ;
            //Ville de Paris
            $membresPHPParis = $repository->MembersByCityRetro('PHP', 'paris', $retroFin, $retroDeb);
            $membresJavaScriptParis = $repository->MembersByCityRetro('JavaScript', 'paris', $retroFin, $retroDeb);
            $membresRubyParis = $repository->MembersByCityRetro('Ruby', 'paris', $retroFin, $retroDeb);
            $membresIOSParis = $repository->MembersByCityRetro('IOS', 'paris', $retroFin, $retroDeb);
            ...
            //Ville de la Loupe
            $membresPHPLoupe = $repository->MembersByCityRetro('PHP', 'la+loupe', $retroFin, $retroDeb);
            $membresJavaScriptLoupe = $repository->MembersByCityRetro('JavaScript', 'la+loupe', $retroFin, $retroDeb);
            $membresRubyLoupe = $repository->MembersByCityRetro('Ruby', 'la+loupe', $retroFin, $retroDeb);
            $membresIOSLoupe = $repository->MembersByCityRetro('IOS', 'la+loupe', $retroFin, $retroDeb);
            ...
            //Ville de Chartres
            $membresPHPChartres = $repository->MembersByCityRetro('PHP', 'Chartres', $retroFin, $retroDeb);
            $membresJavaScriptChartres = $repository->MembersByCityRetro('JavaScript', 'Chartres', $retroFin, $retroDeb);
            $membresRubyChartres = $repository->MembersByCityRetro('Ruby', 'Chartres', $retroFin, $retroDeb);
            $membresIOSChartres = $repository->MembersByCityRetro('IOS', 'Chartres', $retroFin, $retroDeb);
            ...
            //Ville de Fontainebleau
            $membresPHPFontainebleau = $repository->MembersByCityRetro('PHP', 'Fontainebleau', $retroFin, $retroDeb);
            $membresJavaScriptFontainebleau = $repository->MembersByCityRetro('JavaScript', 'Fontainebleau', $retroFin, $retroDeb);
            $membresRubyFontainebleau = $repository->MembersByCityRetro('Ruby', 'Fontainebleau', $retroFin, $retroDeb);
            $membresIOSFontainebleau = $repository->MembersByCityRetro('IOS', 'Fontainebleau', $retroFin, $retroDeb);
            ...
            //Ville de Orleans
            $membresPHPOrleans = $repository->MembersByCityRetro('PHP', 'Orleans', $retroFin, $retroDeb);
            $membresJavaScriptOrleans = $repository->MembersByCityRetro('JavaScript', 'Orleans', $retroFin, $retroDeb);
            $membresRubyOrleans = $repository->MembersByCityRetro('Ruby', 'Orleans', $retroFin, $retroDeb);
            $membresIOSOrleans = $repository->MembersByCityRetro('IOS', 'Orleans', $retroFin, $retroDeb);
            ...
            //Ville de Lyon
            $membresPHPLyon = $repository->MembersByCityRetro('PHP', 'Lyon', $retroFin, $retroDeb);
            $membresJavaScriptLyon = $repository->MembersByCityRetro('JavaScript', 'Lyon', $retroFin, $retroDeb);
            $membresRubyLyon = $repository->MembersByCityRetro('Ruby', 'Lyon', $retroFin, $retroDeb);
            $membresIOSLyon = $repository->MembersByCityRetro('IOS', 'Lyon', $retroFin, $retroDeb);
            ...
            //Ville de Bordeaux
            $membresPHPBordeaux = $repository->MembersByCityRetro('PHP', 'Bordeaux', $retroFin, $retroDeb);
            $membresJavaScriptBordeaux = $repository->MembersByCityRetro('JavaScript', 'Bordeaux', $retroFin, $retroDeb);
            $membresRubyBordeaux = $repository->MembersByCityRetro('Ruby', 'Bordeaux', $retroFin, $retroDeb);
            $membresIOSBordeaux = $repository->MembersByCityRetro('IOS', 'Bordeaux', $retroFin, $retroDeb);
            ...
            //Ville de Toulouse
            $membresPHPToulouse = $repository->MembersByCityRetro('PHP', 'Toulouse', $retroFin, $retroDeb);
            $membresJavaScriptToulouse = $repository->MembersByCityRetro('JavaScript', 'Toulouse', $retroFin, $retroDeb);
            $membresRubyToulouse = $repository->MembersByCityRetro('Ruby', 'Toulouse', $retroFin, $retroDeb);
            $membresIOSToulouse = $repository->MembersByCityRetro('IOS', 'Toulouse', $retroFin, $retroDeb);
            ...
            //Ville de Strasbourg
            $membresPHPStrasbourg = $repository->MembersByCityRetro('PHP', 'Strasbourg', $retroFin, $retroDeb);
            $membresJavaScriptStrasbourg = $repository->MembersByCityRetro('JavaScript', 'Strasbourg', $retroFin, $retroDeb);
            $membresRubyStrasbourg = $repository->MembersByCityRetro('Ruby', 'Strasbourg', $retroFin, $retroDeb);
            $membresIOSStrasbourg = $repository->MembersByCityRetro('IOS', 'Strasbourg', $retroFin, $retroDeb);
            ...
            //Ville de Nantes
            $membresPHPNantes = $repository->MembersByCityRetro('PHP', 'Nantes', $retroFin, $retroDeb);
            $membresJavaScriptNantes = $repository->MembersByCityRetro('JavaScript', 'Nantes', $retroFin, $retroDeb);
            $membresRubyNantes = $repository->MembersByCityRetro('Ruby', 'Nantes', $retroFin, $retroDeb);
            $membresIOSNantes = $repository->MembersByCityRetro('IOS', 'Nantes', $retroFin, $retroDeb);
            ...
            //Ville de Nice
            $membresPHPNice = $repository->MembersByCityRetro('PHP', 'Nice', $retroFin, $retroDeb);
            $membresJavaScriptNice = $repository->MembersByCityRetro('JavaScript', 'Nice', $retroFin, $retroDeb);
            $membresRubyNice = $repository->MembersByCityRetro('Ruby', 'Nice', $retroFin, $retroDeb);
            $membresIOSNice = $repository->MembersByCityRetro('IOS', 'Nice', $retroFin, $retroDeb);
            ...
            //Ville de Montpellier
            $membresPHPMontpellier = $repository->MembersByCityRetro('PHP', 'Montpellier', $retroFin, $retroDeb);
            $membresJavaScriptMontpellier = $repository->MembersByCityRetro('JavaScript', 'Montpellier', $retroFin, $retroDeb);
            $membresRubyMontpellier = $repository->MembersByCityRetro('Ruby', 'Montpellier', $retroFin, $retroDeb);
            $membresIOSMontpellier = $repository->MembersByCityRetro('IOS', 'Montpellier', $retroFin, $retroDeb);
            ...
            //Ville de Rennes
            $membresPHPRennes = $repository->MembersByCityRetro('PHP', 'Rennes', $retroFin, $retroDeb);
            $membresJavaScriptRennes = $repository->MembersByCityRetro('JavaScript', 'Rennes', $retroFin, $retroDeb);
            $membresRubyRennes = $repository->MembersByCityRetro('Ruby', 'Rennes', $retroFin, $retroDeb);
            $membresIOSRennes = $repository->MembersByCityRetro('IOS', 'Rennes', $retroFin, $retroDeb);
            ...
            //Ville de Lille
            $membresPHPLille = $repository->MembersByCityRetro('PHP', 'Lille', $retroFin, $retroDeb);
            $membresJavaScriptLille = $repository->MembersByCityRetro('JavaScript', 'Lille', $retroFin, $retroDeb);
            $membresRubyLille = $repository->MembersByCityRetro('Ruby', 'Lille', $retroFin, $retroDeb);
            $membresIOSLille = $repository->MembersByCityRetro('IOS', 'Lille', $retroFin, $retroDeb);
            ...
            //Ville de Brussels
            $membresPHPBrussels = $repository->MembersByCityRetro('PHP', 'Brussels', $retroFin, $retroDeb);
            $membresJavaScriptBrussels = $repository->MembersByCityRetro('JavaScript', 'Brussels', $retroFin, $retroDeb);
            $membresRubyBrussels = $repository->MembersByCityRetro('Ruby', 'Brussels', $retroFin, $retroDeb);
            $membresIOSBrussels = $repository->MembersByCityRetro('IOS', 'Brussels', $retroFin, $retroDeb);
            ...
            //Ville de Luxembourg
            $membresPHPLuxembourg = $repository->MembersByCityRetro('PHP', 'Luxembourg', $retroFin, $retroDeb);
            $membresJavaScriptLuxembourg = $repository->MembersByCityRetro('JavaScript', 'Luxembourg', $retroFin, $retroDeb);
            $membresRubyLuxembourg = $repository->MembersByCityRetro('Ruby', 'Luxembourg', $retroFin, $retroDeb);
            $membresIOSLuxembourg = $repository->MembersByCityRetro('IOS', 'Luxembourg', $retroFin, $retroDeb);
            ...
            //Ville de Geneve
            $membresPHPGeneve = $repository->MembersByCityRetro('PHP', 'Geneve', $retroFin, $retroDeb);
            $membresJavaScriptGeneve = $repository->MembersByCityRetro('JavaScript', 'Geneve', $retroFin, $retroDeb);
            $membresRubyGeneve = $repository->MembersByCityRetro('Ruby', 'Geneve', $retroFin, $retroDeb);
            $membresIOSGeneve = $repository->MembersByCityRetro('IOS', 'Geneve', $retroFin, $retroDeb);
        ...
        return $this->render('MeetupBundle:Default:accueilRetro.html.twig',
        array(
            'membresParis'            =>$membresParis,
